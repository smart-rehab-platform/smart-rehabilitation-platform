...
const getVerifyEmailAttachments = () => {
...
const renderVerifyEmailTemplate = ({
  heading,
  preheader,
  greeting,
  intro,
...
<p style="margin:0;font-size:12px;line-height:1.6;color:#8FA3BC;font-family:Inter,'Segoe UI',Roboto,Arial,sans-serif">This message was sent by ${APP_NAME}.<br>If you did not create this account, you can safely ignore this email.</p>
</td>
</tr>
</table>
</td>
...
const buildVerifyEmailContent = (templateData) => ({
  html: renderVerifyEmailTemplate(templateData),
  attachments: getVerifyEmailAttachments(),
});

module.exports = {
  LOGO_CID,
  buildVerifyEmailContent,
  getVerifyEmailAttachments,
